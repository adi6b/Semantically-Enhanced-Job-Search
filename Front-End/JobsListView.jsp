<%-- 
    Document   : JobsListView
    Created on : May 4, 2019, 2:30:05 PM
    Author     : agashe
--%>

<%@page import="edu.uga.ei_final.SupportClass"%>
...
<html>
    ...
    <body>
        <% 
            final String BASE_URI = "http://localhost:8081/EI_Final/api";
        
            String name1 = request.getParameter("position");
            out.print(name1);
                        try{
